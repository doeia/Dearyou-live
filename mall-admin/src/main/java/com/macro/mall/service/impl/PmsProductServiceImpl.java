...
public class PmsProductServiceImpl implements PmsProductService {
    ...
    @Override
    public List<PmsProduct> listForRecommend(PmsProductQueryParam queryParam, Integer pageSize, Integer pageNum) {
        PageHelper.startPage(pageNum, pageSize);

        return productDao.getListForRecommend(queryParam);
    }
