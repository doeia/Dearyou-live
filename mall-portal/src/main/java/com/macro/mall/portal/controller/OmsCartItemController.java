...
public class OmsCartItemController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<OmsCartItem>> list(@RequestBody PageParam page) {
        List<OmsCartItem> cartItemList = cartItemService.list(memberService.getCurrentMember().getId(), page);
        return CommonResult.success(CommonPage.restPage(cartItemList));
    }
