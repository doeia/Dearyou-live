  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="所属订单编号" align="center">
          <template slot-scope="scope">
            <p>{{scope.row.commentId}}</p>
          </template>
        </el-table-column>
        <el-table-column label="内容" width="340" align="center">
          <template slot-scope="scope">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.listQuery.commentId = this.$route.query.commentId
