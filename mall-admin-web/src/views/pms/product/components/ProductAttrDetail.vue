  ...
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item label="规格参数：">
        <el-tabs value="pc" type="card">
          <el-tab-pane label="图片信息" name="pc">
            <tinymce :width="595" :height="300" v-model="value.detailHtml"></tinymce>
          </el-tab-pane>
          <el-tab-pane label="购买详情" name="mobile">
  ...
  export default {
    ...
    methods: {
      ...
      mergeProductAttrValue() {
        ...
        // console.log(this.selectProductAttr, this.value.productAttributeValueList)
      },
      //合并商品属性图片
