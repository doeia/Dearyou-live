    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell">{{order.memberNickname}}</el-col>
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell">{{order.autoConfirmDay|formatAutoConfirmDay}}</el-col>
...
<script>
  ...
  export default {
    ...
    filters: {
      formatAutoConfirmDay(value) {
        return value ? value + '天' : '暂无'
      },
      formatNull(value) {
    ...
    methods: {
      ...
      async showLogisticsDialog() {
        const response = await getLogistics(this.order.id)
