<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()" v-if="hasPermission('sms:advertise:create')">添加广告
      </el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="广告名称" width="300" align="center">
...
<!--        </el-table-column>-->
        <el-table-column label="上线/下线" width="120" align="center">
          <template slot-scope="scope">
            <el-switch
              :disabled="!hasPermission('sms:advertise:update')"
        ...
        <el-table-column label="操作" width="120" fixed="right" align="center"
                         v-if="hasPermission('sms:advertise:update')||hasPermission('sms:advertise:delete')">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       v-if="hasPermission('sms:advertise:update')"
                       @click="handleUpdate(scope.$index, scope.row)">编辑
            </el-button>
            <el-button size="mini"
                       type="text"
                       v-if="hasPermission('sms:advertise:delete')"
    ...
    <div class="batch-operate-container" v-if="hasPermission('sms:advertise:delete')">
      <el-select
        size="small"
