  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="coupon"
      ...
      <el-form-item label="优惠券封面图：">
        <el-form-item>
          <single-upload v-model="coupon.pic"></single-upload>
        </el-form-item>
      ...
      <el-form-item label="面额：" prop="amount">
        <el-input v-model.float="coupon.amount" placeholder="面值只能是数值，限2位小数" class="input-width">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          amount: [
            {pattern: /(?!0\.00)(\d+\.\d{2}$)/, required: true, message: '面值只能是数值，0.01-10000，限2位小数', trigger: 'blur'}
          ],
          minPoint: [
            {type: 'number', required: true, message: '只能输入正整数', trigger: 'blur'}
          ]
