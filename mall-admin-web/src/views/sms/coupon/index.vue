<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()" v-if="hasPermission('sms:coupon:create')">添加
      </el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="couponTable"
        ...
        <el-table-column label="操作" width="180" fixed="right" align="center"
                         v-if="hasPermission('sms:couponHistory:list')||hasPermission('sms:coupon:update')||hasPermission('sms:coupon:delete')">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       v-if="hasPermission('sms:couponHistory:list')"
                       @click="handleView(scope.$index, scope.row)">查看
            </el-button>
            <el-button size="mini"
                       type="text"
                       v-if="hasPermission('sms:coupon:update')"
                       @click="handleUpdate(scope.$index, scope.row)">
              编辑
            </el-button>
            <el-button size="mini"
                       type="text"
                       v-if="hasPermission('sms:coupon:delete')"
