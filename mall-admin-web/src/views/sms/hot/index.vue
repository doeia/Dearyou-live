  ...
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleSelectProduct()"
                 v-if="hasPermission('sms:recommendProduct:create')">选择商品
      </el-button>
    </el-card>
      ...
      <el-table ref="newProductTable"
        ...
        <el-table-column label="是否推荐" width="200" align="center">
          <template slot-scope="scope">
            <el-switch
              :disabled="!hasPermission('sms:recommendProduct:update')"
        ...
        <el-table-column label="操作" width="180" fixed="right" align="center"
                         v-if="hasPermission('sms:recommendProduct:update')||hasPermission('sms:recommendProduct:delete')">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       v-if="hasPermission('sms:recommendProduct:update')"
                       @click="handleEditSort(scope.$index, scope.row)">设置排序
            </el-button>
            <el-button size="mini"
                       type="text"
                       v-if="hasPermission('sms:recommendProduct:delete')"
    ...
    <div class="batch-operate-container" v-if="operates.length">
      <el-select
        size="small"
...
<script>
  ...
  import {fetchRecommendList as fetchProductList} from '../../../api/product'
  ...
  export default {
    ...
    computed: {
      operates() {
        let _o = []
        if (this.hasPermission('sms:recommendProduct:update')) {
          _o = [
            {
              label: '设为推荐',
              value: 0
        ...
        if (this.hasPermission('sms:recommendProduct:delete')) {
          _o = [
            {
              label: '删除',
              value: 2
